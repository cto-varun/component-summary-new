                ...
                payload: {
                    ...
                    properties: {
                        use: {
                            type: 'string',
                            title:
                                'When used with the data processor, use this to set payload data from somewhere in data processor',
                            example:
                                'dataProcessorObject.propertyToUseForPayload',
                        },
                    },
                    items: {
            ...
            sections: {
                ...
                properties: {
                    transformations: {
                        type: 'array',
                        title:
                            'A list of inline function transformations to apply to data',
                        default: [],
                    },
                    items: {
                        type: 'array',
